...
public class PreferencesUtils {
    ...
    public static String PREFERENCE_NAME = "RelaxSP";
    ...
    public static <T> void putGson(Context context, String key, T object) {
        String json = "";
        Gson gson = new Gson();
        try {
    ...
    public static <T> T getGson(Context context, String key, Type typeOfT) {
    ...
    public static boolean put(Context context, String key, Object value) {
        ...
        if (value instanceof String) {
            result = putString(context, key, (String) value);
        } else if (value instanceof Integer) {
            result = putInt(context, key, (Integer) value);
        } else if (value instanceof Integer) {
            result = putLong(context, key, (Long) value);
        } else if (value instanceof Integer) {
            result = putFloat(context, key, (Float) value);
        } else if (value instanceof Integer) {
            result = putBoolean(context, key, (Boolean) value);
        }
        return result;
    }
    ...
    public static <T> T get(Context context, String key, T defaultValue) {
        ...
        if (defaultValue instanceof String) {
            result = getString(context, key, (String) defaultValue);
        } else if (defaultValue instanceof Integer) {
            result = getInt(context, key, (Integer) defaultValue);
        } else if (defaultValue instanceof Integer) {
            result = getLong(context, key, (Long) defaultValue);
        } else if (defaultValue instanceof Integer) {
            result = getFloat(context, key, (Float) defaultValue);
        } else if (defaultValue instanceof Integer) {
            result = getBoolean(context, key, (Boolean) defaultValue);
        }
        return (T) result;
    }
}
