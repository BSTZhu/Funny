...
public class ProgressRequestBody extends RequestBody {
    ...
    protected com.free.funny.relax.base.network.progress.ProgressListener listener;     //进度回调接口
    protected CountingSink countingSink; //包装完成的BufferedSink

    public ProgressRequestBody(RequestBody delegate, com.free.funny.relax.base.network.progress.ProgressListener listener) {
