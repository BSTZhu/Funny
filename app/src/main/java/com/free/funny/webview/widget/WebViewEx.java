package com.free.funny.webview.widget;
...
public class WebViewEx extends WebView {
    ...
    private void injectJavascriptInterfaces() {
        ...
        if (!TextUtils.isEmpty(mJsStringCache) && mJsStringCache.equals(jsString)) {
    ...
    private boolean handleJsInterface(WebView view, String url, String message, String defaultValue,
        ...
        if (TextUtils.isEmpty(message) || !message.startsWith(prefix)) {
            return false;
        }
